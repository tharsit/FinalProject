<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mainpage.aspx.cs" Inherits="FinalWebProject.Library.Mainpage" EnableEventValidation="true" %>
    ...
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" Height="638px">
            ...
            <td  style="text-align:center" class="style4"> 
                <asp:Label ID="Label1" 
                    runat="server" ForeColor="Black" Text="Top Three Books in Myanmar" 
            ...
            <asp:Label ID="Label2" runat="server" ForeColor="Black" Text="Top 1" 
                    style=" text-align:center"></asp:Label>
            </td>
             <td class="style6" style="text-align:center">
            <asp:Label ID="Label3" runat="server" ForeColor="Black" Text="Top 2" 
                     style="font-size: 10pt; text-align:center"></asp:Label>
            </td>
             <td class="style5" style="text-align:center">
            <asp:Label ID="Label4" runat="server" ForeColor="Black" Text="Top 3" 
                     style="font-size: 10pt; text-align:center"></asp:Label>
            </td>
            </tr>
            <tr>
           ...
           <img src="..\image\download.jpg" style="height: 195px; width: 134px" />
            ...
            <div >
                    ...
                    Width="193px" Height="52px" /></div>
                             <asp:GridView ID="GridView1" runat="server"
                                DataKeyNames="Book_ID" AutoGenerateSelectButton="True"
                                OnRowCommand="GridView1_RowCommand"
                                SelectionMode="Single" Width="1184px" CellPadding="4" 
                ...
                <table>
                    <tr>
                        <td style="text-align: left">
                            <asp:Button ID="btncart" runat="server" OnClick="btncart_Click" Text="Cart"
                                Style="text-align:center" Height="50px" Width="204px" /></td>
                        <td style="text-align: right">
                            <asp:Button ID="Button1" runat="server" Height="50px" Text="Admin"
                                Style="text-align:center" Width="210px" OnClick="Button1_Click" />
                        </td>
                    </tr>
                </table>
